...
def get_data_loader(train_dataset, val_dataset, test_dataset, batch_size, num_workers):
    ...
    test_loader = DataLoader(test_dataset, batch_size=batch_size, collate_fn=my_collate, num_workers=num_workers, shuffle=False)

    return train_loader, val_loader, test_loader, weighted_sampler
